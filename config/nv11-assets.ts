...
export const NV11_LOOPS = {
  heroEnergy: "nv11-vid-loop-001-hero-energy.webm",
  owlBreath: "nv11-vid-loop-002-owl-breath.webm",
  chaosDrift: "nv11-vid-loop-003-chaos-drift.webm",
  pillarsPulse: "nv11-vid-loop-004-pillars-pulse.webm",
  demoCorridor: "nv11-vid-loop-005-demo-corridor.webm",
  portalsFlow: "nv11-vid-loop-006-portals-flow.webm",
  neuralPulse: "nv11-vid-loop-007-neural-pulse.webm",
  inboxStreams: "nv11-vid-loop-008-inbox-streams.webm",
  funnelOrbs: "nv11-vid-loop-009-funnel-orbs.webm",
  synapseBurst: "nv11-vid-loop-010-synapse-burst.webm",
  chartsBreathe: "nv11-vid-loop-011-charts-breathe.webm",
  starsPulse: "nv11-vid-loop-012-stars-pulse.webm",
  splitMist: "nv11-vid-loop-013-split-mist.webm",
  verticalsPulse: "nv11-vid-loop-014-verticals-pulse.webm",
  trustGather: "nv11-vid-loop-015-trust-gather.webm",
  orbitFilaments: "nv11-vid-loop-016-orbit-filaments.webm",
  portalGrid: "nv11-vid-loop-017-portal-grid.webm",
  decisionRings: "nv11-vid-loop-018-decision-rings.webm",
  goldRivers: "nv11-vid-loop-019-gold-rivers.webm",
} as const;

export const NV11_F2F_VIDEOS = {
  "NV11-F2F-000": "nv11-vid-f2f-000-hero-core.webm",
  "NV11-F2F-001": "nv11-vid-f2f-001-owl-eyes.webm",
  "NV11-F2F-002": "nv11-vid-f2f-002-crm-awaken.webm",
  "NV11-F2F-003": "nv11-vid-f2f-003-data-evolution.webm",
  "NV11-F2F-004": "nv11-vid-f2f-004-cta-convergence.webm",
} as const;
